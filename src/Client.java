...
public class Client implements ActionListener {
    ...
    Client()
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Monika.png"));
        ...
        JLabel l3 = new JLabel("Monika");
        l3.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        l3.setForeground(Color.WHITE);
        l3.setBounds(110,15,100,18);
        p.add(l3);
        
        final JLabel l4 = new JLabel("Active now");
...
//        f1.add(a1);
        ...
        f1.setLocation(800,100); // on screen where frame will be visible
...
//        a1.add(p2);
    ...
    {
        new Client().f1.setVisible(true); //object made to call constructor
